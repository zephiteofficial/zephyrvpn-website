        ...
        <div className="mx-auto max-w-max text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group p-6 w-80 h-42 bg-background text-left transition duration-300 ease-in-out hover:bg-opacity-50 hover:bg-gradient-to-t hover:from-neutral-900 hover:to-transparent backdrop-blur-md border-x border-b border-opacity-50 border-gray-700 relative" 
              >
        ...
        <div className="mx-auto max-w-max text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0">
            {features2.map((features2, index2) => (
              <div
                key={index2}
                className="group p-6 w-80 h-42 bg-background text-left transition duration-300 ease-in-out hover:bg-opacity-50 hover:bg-gradient-to-b hover:from-neutral-900 hover:to-transparent backdrop-blur-md border-x border-t border-opacity-50 border-gray-700 relative" 
              >
